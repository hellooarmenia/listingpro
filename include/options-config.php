...
//        ) );
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'enable_coupons_search_filter',
                'type' => 'switch',
                'required' => array('enable_search_filter', '=', '1'),
                'title' => esc_html__('Coupons', 'listingpro'),
                'desc' => '',
                'subtitle' => '',
                'default' => 1,
                'on' => esc_html__('Enabled', 'listingpro'),
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => __('Select Image used for Create Ad Popup', 'listingpro'),
            ...
            array(
                ...
                'desc'  => 'Title for Create Ad Campaign Popup',
                'read-only' => false,
